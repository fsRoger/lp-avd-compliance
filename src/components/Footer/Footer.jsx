...
const Footer = () => {
  return (
    <div className=" pt-10 ">
      ...
      <div className=' bg-cyan-600 text-white w-full py-12'>
      ...
      <div className='bg-[rgb(16,31,45)] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 py-12 md:py-20 px-4 '>
        <div className="flex items-center justify-center gap-4 ">
          <Image src='/images/website/logo.png' width={60} height={100} className='w-[60px] md:w-[100px]' alt="Logo" />
